...
// NOTE: This is deprecated but some code might be able to be reused in audioplayer
...
{
	public SFXAudioClip(string path, float volume, AudioMixerGroup mixerGroup, Action trigger)
	{
